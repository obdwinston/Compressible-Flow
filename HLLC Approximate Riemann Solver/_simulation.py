...
for nt in range(Nt):
    ...
    Ue[nxR - 1, nyB:nyT, 1] = -Uw[nxR, nyB:nyT, 1]
    Ue[nxR - 1, nyB:nyT, 2] = Uw[nxR, nyB:nyT, 2]
    Ue[nxR - 1, nyB:nyT, 3] = Uw[nxR, nyB:nyT, 3]
    # body bottom
    ...
    Un[nxL:nxR, nyT - 1, 2] = -Us[nxL:nxR, nyT, 2]
    Un[nxL:nxR, nyT - 1, 3] = Us[nxL:nxR, nyT, 3]
    ...
    Ue_bar[nxR - 1, nyB:nyT, 1] = -Uw_bar[nxR, nyB:nyT, 1]
    Ue_bar[nxR - 1, nyB:nyT, 2] = Uw_bar[nxR, nyB:nyT, 2]
    Ue_bar[nxR - 1, nyB:nyT, 3] = Uw_bar[nxR, nyB:nyT, 3]
    # body bottom
    ...
    Un_bar[nxL:nxR, nyT - 1, 2] = -Us_bar[nxL:nxR, nyT, 2]
    Un_bar[nxL:nxR, nyT - 1, 3] = Us_bar[nxL:nxR, nyT, 3]
    ...
    np.save(os.path.join('data_hllc', 'U{:d}'.format(nt)), U)
